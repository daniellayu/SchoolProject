...
class StudentLastLessons(tkinter.Toplevel):
    def __init__(self, parent):
        super().__init__(parent)
        self.parent = parent
        self.geometry('800x450+350+50')
        self.title('Student Last Lessons Screen')
    ...
    def listbox(self):
        arr = ["student_lessons_list", self.parent.parent.id_s]
        str1 = arr[0] + "," + (arr[1])
        print(str1)
        ...
        for item in arr_data:
            ...
            teacher_name = self.parent.parent.parent.recv_msg(self.parent.parent.parent.client_socket)
